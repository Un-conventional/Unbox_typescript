...
export class ThemePrompt implements Prompt {
	private readonly _themeSelect: HTMLSelectElement = select({ style: "width: 100%;" },
		optgroup({ label: "Default Themes" },
			...
			option({ value: "4-bit mono"}, "4-bit Mono"),					//16 values - Black and White with Grays in between.				| Monochrome displays - MOS VDC / C128 monochrome monitor, Amstrad CPC, Apple PowerBooks...
			...
			option({ value: "2+2-bit rgb"}, "Channel F"),			//8 values - ^ 3bits? rgb 													|IBM8514, Atari Falcon(256), Nintendo DS(3d),Many LCD monitors...
